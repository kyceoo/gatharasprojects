    ...
    source: {
        ...
        define: {
            'process.env': {
                ...
                VITE_APPWRITE_DATABASE_ID: JSON.stringify(process.env.VITE_APPWRITE_DATABASE_ID),
                VITE_APPWRITE_SITES_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_SITES_COLLECTION_ID),
                VITE_APPWRITE_DEPLOYMENTS_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_DEPLOYMENTS_COLLECTION_ID),
                VITE_APPWRITE_USERS_METADATA_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_USERS_METADATA_COLLECTION_ID),
                VITE_APPWRITE_DOMAIN_OWNERSHIP_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_DOMAIN_OWNERSHIP_COLLECTION_ID),
                VITE_APPWRITE_ANNOUNCEMENTS_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_ANNOUNCEMENTS_COLLECTION_ID),
                VITE_APPWRITE_XML_BOTS_COLLECTION_ID: JSON.stringify(process.env.VITE_APPWRITE_XML_BOTS_COLLECTION_ID),
            },
        },
        alias: {
